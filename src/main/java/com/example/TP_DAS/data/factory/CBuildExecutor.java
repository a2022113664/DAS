...
public class CBuildExecutor extends BuildExecutor{
    public CBuildExecutor() {
        super(); // Initialize the base class constructor
    }

    public CBuildExecutor(ExecutorService executorService) {
    ...
    public BuildResult executeBuild(BuildRequest request) throws InterruptedException, IOException {
        ...
        ProcessBuilder builder = new ProcessBuilder("gcc", "-Wall", "-o", request.getProjectId(), request.getSourceCode());
